...
@section('menu-data')
<input type="hidden" name="" class="menu-data" value="branch-group | branch">
@endsection()
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6">
                <div class="align-justify-center">
                    <a href="#" class="btn btn-default btn-md flex-right tab-action" atr="Create">Create New<i class="fas fa-plus m-l-5"></i></a>
                </div>
            </div>
        </div>
        <div class="m-t-25">
...
@include('admin.manager.branch.create')
@include('admin.manager.branch.delete')
...
<script src="{{ asset('manager/assets/js/page/branch.js') }}"></script>
