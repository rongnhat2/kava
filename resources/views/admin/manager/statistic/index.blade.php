            ...
            <div class="card">
                <div class="card-header pb-0 border-0 d-flex flex-wrap gap-2 align-items-center justify-content-between">
                    ...
                    <ul class="nav nav-pills nav-pills-custom nav-fill p-1 bg-light rounded-5" id="chartRevenueTabs" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active rounded-5" id="todayRevenueTab" data-bs-toggle="tab" type="button" role="tab" aria-selected="false" tabindex="-1">
                                Today
                            </button>
                        </li>
                        <!-- <li class="nav-item" role="presentation">
                ...
                <div class="card-body pb-0">
                    <div class="d-flex gap-5">
                        <div class="mb-2">
                            <h6 class="mb-0">
                                <span class="text-body">Total Buy: $</span>{{ number_format($profit_buy, 0, ',', '.') }}<span class="text-primary"> </span>
                            </h6>
                        </div>
                        <div class="mb-2">
                            <h6 class="mb-0">
                                <span class="text-body">Total Sell: $</span>{{ number_format($profit_sell, 0, ',', '.') }}<span class="text-primary"> </span>
                            </h6>
                        </div>
                    </div>
            ...
            <div class="card overflow-hidden">
                ...
                <div class="card-footer border-0">
                    ...
                    <div class="progress-stacked bg-transparent mb-4">
                        <div class="progress bg-transparent" role="progressbar" aria-label="Segment one" aria-valuenow="15" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo $percentBuy; ?>%">
                            <div class="progress-bar bg-primary"></div>
                        </div>
                        <div class="progress bg-transparent" role="progressbar" aria-label="Segment two" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo $percentSell; ?>%">
                    ...
                    <div class="row g-1">
                        ...
                        <div class="col-xxl-12 col-lg-6 col-md-12 col-sm-6">
                            <div class="p-3 border rounded">
                                ...
                                <div class="d-flex align-items-center mb-1">
                                    <h5 class="mb-0">{{ $account->transactions_count }} <span class="text-2xs text-body ms-1">Transactions with total volume {{ $account->total_volume  }}$</span>
                                    </h5>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card-header d-flex flex-wrap gap-3 align-items-center justify-content-between border-0 pb-0">
                    ...
                    <div id="dt_RecentTransactions_Search">
                        <div class="dt-search"><i class="fi fi-rr-search"></i>
                            <input type="search" class="form-control form-control-sm" id="dt-search-0" placeholder="Search for transactions..." aria-controls="dt_RecentTransactions">
                        </div>
                    </div>
                </div>
                    ...
                    <div id="dt_RecentTransactions_wrapper" class="dt-container dt-bootstrap5 dt-empty-footer">
                        <div class="row mt-2 justify-content-between dt-layout-table">
                            <div class="d-md-flex justify-content-between align-items-center col-12 dt-layout-full col-md">
                                <table id="dt_RecentTransactions" class="table table-sm display table-row-rounded dataTable" aria-describedby="dt_RecentTransactions_info" style="width: 100%;">
                                    <colgroup>
                                    ...
                                    <thead class="table-light">
                                        <tr>
                                            <th class="minw-150px dt-orderable-none dt-ordering-asc" data-dt-column="0">
                                                <div class="dt-column-header"><span class="dt-column-title">Customer</span></div>
                                            </th>
                                            <th class="minw-120px dt-orderable-asc dt-orderable-desc" data-dt-column="1">
                                                <div class="dt-column-header"><span class="dt-column-title">Date</span></div>
                                            </th>
                                            <th class="minw-200px dt-orderable-asc dt-orderable-desc" data-dt-column="2">
                                                <div class="dt-column-header"><span class="dt-column-title">Transaction Hash</span></div>
                                            </th>
                                            <th data-dt-column="3" class="dt-orderable-asc dt-orderable-desc">
                                                <div class="dt-column-header"><span class="dt-column-title">Type</span></div>
                                            </th>
                                            <th data-dt-column="4" class="dt-type-numeric dt-orderable-asc dt-orderable-desc">
                                                <div class="dt-column-header"><span class="dt-column-title">Amount</span></div>
                                            </th>
                                            <th data-dt-column="5" class="dt-orderable-asc dt-orderable-desc">
                                                <div class="dt-column-header"><span class="dt-column-title">Status</span></div>
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="https://testnet.kavascan.io/tx/{{ $transaction->transaction_hash }}" target="_blank">
                                            ...
                                            <td class="text-{{ $transaction->type == 'Swap USDT to KAVA' ? 'success' : 'danger' }} fw-bold dt-type-numeric">{{ $transaction->type == "Swap USDT to KAVA" ? "+" : "-" }}{{$transaction->amount}}</td>
                                            <td>
                                                <span class="badge badge-lg bg-success-subtle text-success">Success</span>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
