    ...
    series: [
        {
            name: "Buy Volumn",
            data: [
                3500, 5000, 4200, 5500, 5000, 6200, 4800, 6500, 5800, 7200,
                6600, 7500,
            ],
        },
        {
            name: "Sell Volumn",
            data: [
                2500, 3100, 2900, 3700, 3300, 4100, 3600, 3900, 4200, 4000,
                4600, 4300,
            ],
        },
    ],
    ...
    document.querySelector("#todayRevenueTab").addEventListener("click", () => {
        chartTabsInit.updateOptions({
            ...
            series: [
                {
                    data: [
                        500, 700, 650, 800, 900, 950, 880, 920, 970, 1020, 1100,
                        1200,
                    ],
                },
                {
                    data: [
                        300, 450, 400, 500, 480, 530, 490, 510, 560, 580, 600,
                        650,
                    ],
                },
            ],
    ...
    document.querySelector("#monthRevenueTab").addEventListener("click", () => {
        chartTabsInit.updateOptions({
            ...
            series: [
                {
                    data: [
                        3500, 5000, 4200, 5500, 5000, 6200, 4800, 6500, 5800,
                        7200, 6600, 7500,
                    ],
                },
                {
                    data: [
                        2500, 3100, 2900, 3700, 3300, 4100, 3600, 3900, 4200,
                        4000, 4600, 4300,
                    ],
                },
            ],
