    ...
    multiImage: {
        ...
        getVal() {
            ...
            $(".image-loader").each(function (index) {
                string_data +=
                    $(this).find(".image-preview-item").attr("data-src") + ",";
            });
            return string_data;
        },
        init() {
...
(() => {
    ...
    function init() {
        $(document).on("change", ".note-image-input", function () {
            ...
            IndexView.helper.showToastProcessing(
                "Processing",
